...
Arjun Vohra <arjun.vohra@yale.edu>
Attachments
Nov 30, 2025, 2:14 PM (2 days ago)
to Athena, me, Disha

Here is the streamlit code for the full model and reduced model, as well as the presaved models for each. I also have included how I got the reduced model using athena's original code :) app.py --> full model, app_reduced.py --> reduced model that only asks for the relevant variables.

final_project_with_reduced_model.ipynb --> code for how the model was made + evaluating its efficiency
